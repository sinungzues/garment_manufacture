var handleTotalSalesSparkline = function () {
  var options = {
    ...
    fill: {
      ...
      gradient: {
        ...
        opacityTo: 1,
        colorStops: [
          { offset: 0, color: app.color.blue, opacity: 1 },
          { offset: 100, color: app.color.indigo, opacity: 1 },
        ],
      },
    },
    series: [
  ...
  if ($("#total-sales-sparkline").length !== 0) {
    new ApexCharts(
      document.querySelector("#total-sales-sparkline"),
      options
    ).render();
  }
};
var handleConversionRateSparkline = function () {
  var options = {
    ...
    fill: {
      ...
      gradient: {
        ...
        opacityTo: 1,
        colorStops: [
          { offset: 0, color: app.color.red, opacity: 1 },
          { offset: 50, color: app.color.orange, opacity: 1 },
  ...
  if ($("#conversion-rate-sparkline").length !== 0) {
    new ApexCharts(
      document.querySelector("#conversion-rate-sparkline"),
      options
    ).render();
  }
};
var handleStoreSessionSparkline = function () {
  var options = {
    ...
    fill: {
      ...
      gradient: {
        ...
        opacityTo: 1,
        colorStops: [
          { offset: 0, color: app.color.teal, opacity: 1 },
          { offset: 50, color: app.color.blue, opacity: 1 },
  ...
  if ($("#store-session-sparkline").length !== 0) {
    new ApexCharts(
      document.querySelector("#store-session-sparkline"),
      options
    ).render();
  }
};
...
var handleVisitorsMap = function () {
  var fillColor = $("#visitors-map").attr("data-theme")
    ? "rgba(" + app.color.componentColorRgb + ", .25)"
    : app.color.gray700;
  var options = {
    map: "world_mill",
    ...
    zoomButtons: false,
    markerStyle: {
      initial: { fill: app.color.black, stroke: "transparent", r: 3 },
    },
...
var handleDateRangeFilter = function () {
  $("#daterange-filter span").html(
    moment().subtract(7, "days").format("D MMMM YYYY") +
      " - " +
      moment().format("D MMMM YYYY")
  );
  $("#daterange-prev-date").html(
    moment().subtract(15, "days").format("D MMMM") +
      " - " +
      moment().subtract(8, "days").format("D MMMM YYYY")
  );
  $("#daterange-filter").daterangepicker(
    ...
    function (start, end, label) {
      ...
      $("#daterange-prev-date").html(
        moment(start).subtract(gap, "days").format("D MMMM") +
          " - " +
          moment(start).subtract(1, "days").format("D MMMM YYYY")
      );
    }
  );
};
