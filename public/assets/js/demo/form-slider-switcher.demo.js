var renderSwitcher = function () {
  if ($("[data-render='switchery']").length !== 0) {
    $("[data-render='switchery']").each(function () {
      ...
      var switchery = new Switchery(this, { color: themeColor });
    });
  }
};
...
var renderPowerRangeSlider = function () {
  if ($("[data-render='powerange-slider']").length !== 0) {
    $("[data-render='powerange-slider']").each(function () {
      var option = {};
      option.decimal = $(this).attr("data-decimal")
        ? $(this).attr("data-decimal")
        : false;
      option.disable = $(this).attr("data-disable")
        ? $(this).attr("data-disable")
        : false;
      option.disableOpacity = $(this).attr("data-disable-opacity")
        ? parseFloat($(this).attr("data-disable-opacity"))
        : 0.5;
      option.hideRange = $(this).attr("data-hide-range")
        ? $(this).attr("data-hide-range")
        : false;
      option.klass = $(this).attr("data-class")
        ? $(this).attr("data-class")
        : "";
      option.min = $(this).attr("data-min")
        ? parseInt($(this).attr("data-min"))
        : 0;
      option.max = $(this).attr("data-max")
        ? parseInt($(this).attr("data-max"))
        : 100;
      option.start = $(this).attr("data-start")
        ? parseInt($(this).attr("data-start"))
        : null;
      option.step = $(this).attr("data-step")
        ? parseInt($(this).attr("data-step"))
        : null;
      option.vertical = $(this).attr("data-vertical")
        ? $(this).attr("data-vertical")
        : false;
      if ($(this).attr("data-height")) {
        $(this)
          .closest(".powerange-wrapper")
