...
@section('title', 'PT BSGI | Add New Position')
@section('content')
    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
        <div class="panel-heading">
            <h4 class="panel-title">ADD NEW POSITION</h4>

        </div>

        <div class="panel-body">
            <a href="/position" class="btn btn-sm btn-danger mb-3"><i class="fa fa-angles-left"></i> Back</a>
            <form class="form-horizontal" data-parsley-validate="true" action="/position" method="post">
                @csrf
