...
@section('title', 'CLOUD | Attendance')
@section('content')
            ...
            <table id="data-table-default" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
                <thead>
                    <tr>
                        ...
                        <th class="text-nowrap text-center">Absen Masuk</th>
                        <th class="text-nowrap text-center">Absen Keluar</th>
                        <th class="text-nowrap text-center">Over Time</th>
                    </tr>
                </thead>
                <tbody>
